<template>
  <div class="flex justify-between w-full my-5">
    <button
      ...
      class="rounded-xl bg-brand-gray hover:bg-gray-100 flex flex-col justify-center items-center p-5 w-28 cursor-pointer focus:outline-none"
    >
      <div class="w-12">
        <img src="../../assets/images/issue.png" alt="problema" />
      </div>
    ...
    >
      <div class="w-12">
        <img src="../../assets/images/idea.png" alt="problema" />
      </div>
    ...
    >
      <div class="w-12">
        <img src="../../assets/images/other.png" alt="problema" />
      </div>
