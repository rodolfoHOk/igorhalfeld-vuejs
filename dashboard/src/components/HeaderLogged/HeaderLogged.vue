    ...
    <div class="flex">
      <ul class="flex list-none">
        <li
          ...
          class="px-6 py-2 mr-2 font-bold text-lg text-white rounded-full cursor-pointer focus:outline-none"
        >
          Credenciais
        </li>
        ...
        <li
          id="logout-button"
          @click="handleLogout"
          class="px-6 py-2 font-bold text-lg bg-white text-brand-main rounded-full cursor-pointer focus:outline-none"
        >
          {{ logoutLabel }}
        </li>
      </ul>
